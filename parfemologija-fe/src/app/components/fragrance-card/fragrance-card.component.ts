...
@Component({
  ...
  host: {
    class: 'w-full sm:w-1/2 lg:w-1/3 h-auto flex flex-col justify-start items-center bg-(--secondary-300) scale-95 rounded-xl outline-(--secondary-500) outline-2 hover:outline-4'
  }
})
